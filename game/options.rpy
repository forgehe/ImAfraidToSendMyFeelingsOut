...
define config.name = _("ImAfraidToSendMyFeelingsOut")
...
define build.name = "ImAfraidToSendMyFeelingsOut"
...
define config.save_directory = "ImAfraidToSendMyFeelingsOut-1537128457"
